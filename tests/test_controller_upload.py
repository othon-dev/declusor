...
@pytest.mark.asyncio
async def test_call_upload_parses_filepath_argument(
    mock_session: AsyncMock, mock_router: MagicMock, temp_file: Path
) -> None:
    """
...
@pytest.mark.asyncio
async def test_call_upload_missing_filepath_raises(
...
@pytest.mark.asyncio
async def test_call_upload_parses_quoted_path(
    mock_session: AsyncMock, mock_router: MagicMock, temp_file: Path
) -> None:
    """
...
@pytest.mark.asyncio
async def test_call_upload_validates_file_exists(
    mock_session: AsyncMock, mock_router: MagicMock, temp_file: Path
) -> None:
    """
...
@pytest.mark.asyncio
async def test_call_upload_nonexistent_file_raises(
    mock_session: AsyncMock, mock_router: MagicMock
) -> None:
    """
...
@pytest.mark.asyncio
async def test_call_upload_directory_raises(
...
@pytest.mark.asyncio
async def test_call_upload_creates_upload_file_command(
    mock_session: AsyncMock, mock_router: MagicMock, temp_file: Path
) -> None:
    """
...
@pytest.mark.asyncio
async def test_call_upload_sends_to_session(
    mock_session: AsyncMock, mock_router: MagicMock, temp_file: Path
) -> None:
    """
    Given: call_upload with valid file
...
@pytest.mark.asyncio
async def test_call_upload_reads_response(
    mock_session: AsyncMock, mock_router: MagicMock, temp_file: Path
) -> None:
    """
...
@pytest.mark.asyncio
async def test_call_upload_shows_stored_path(
    mock_session: AsyncMock, mock_router: MagicMock, mock_console: MagicMock, temp_file: Path
) -> None:
    """
