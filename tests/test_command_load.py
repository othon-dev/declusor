...
@pytest.mark.asyncio
async def test_load_payload_execute_writes_file_content(
    mock_session: AsyncMock, temp_payload: Path
) -> None:
    """
...
@pytest.mark.asyncio
async def test_load_payload_execute_writes_bytes(
    mock_session: AsyncMock, temp_payload: Path
) -> None:
    """
...
@pytest.mark.asyncio
async def test_load_payload_execute_reads_file_at_execution_time(
    mock_session: AsyncMock, temp_payload: Path
) -> None:
    """
...
@pytest.mark.asyncio
async def test_load_payload_execute_raises_on_load_failure(
    mock_session: AsyncMock, temp_payload: Path
) -> None:
    """
...
@pytest.mark.asyncio
async def test_load_payload_execute_raises_with_filepath_in_message(
    mock_session: AsyncMock, temp_payload: Path
) -> None:
    """
...
@pytest.mark.asyncio
async def test_load_payload_handles_empty_file(
    mock_session: AsyncMock, tmp_path: Path
) -> None:
    """
...
@pytest.mark.asyncio
async def test_load_payload_handles_binary_content(
    mock_session: AsyncMock, tmp_path: Path
) -> None:
    """
...
@pytest.mark.asyncio
async def test_load_payload_handles_multiline_script(
    mock_session: AsyncMock, temp_payload: Path
) -> None:
    """
