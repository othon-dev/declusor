...
class TestParseUtil(unittest.TestCase):
    def test_parse_simple(self) -> None:
        ...
        parsed, unknown = parsing.parse_command_arguments(line, definitions)
    ...
    def test_parse_allow_unknown(self) -> None:
        ...
        parsed, unknown = parsing.parse_command_arguments(line, definitions, allow_unknown=True)
    ...
    def test_parse_error_missing_arg(self) -> None:
        ...
        with self.assertRaises(ArgumentParsingError):
            parsing.parse_command_arguments(line, definitions)
    ...
    def test_parse_error_unknown_arg_not_allowed(self) -> None:
        ...
        with self.assertRaises(ArgumentParsingError):
            parsing.parse_command_arguments(line, definitions, allow_unknown=False)
